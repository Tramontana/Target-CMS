<?php
	////////////////////////////////////////////////////////////////////////////
	// The main content area for the TCMS Editor section.
	class Editor extends DIV
	{
		...
		function __construct($head)
		{
			...
			if ($content == "contact")
			{
				...
				$inner->add(Contact::doContact("topE", "editor"));
			}
			else
			{
				// Get regular content
				$inner->add(FN::get("editor", $content));
			}
			$link = new A(NULL, NULL, "Editors", "?template=topE&content=intro");
